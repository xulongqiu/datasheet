...
rom const UINT8 *rom USB_SD_Ptr[]={&sd000,&sd001,&sd002};
...
ROM USB_DEVICE_DESCRIPTOR device_dsc=
{
    ...
    0x0779,                     // Vendor ID: Fairchild Semiconductor       = 0x0779
    0x1118,                     // Product ID: Standard HID USB-I2C Device  = 0x1118
...
{'S','t','a','n','d','a','r','d',' ','H','I','D',' ','U','S','B','-','I','2','C'
}};
