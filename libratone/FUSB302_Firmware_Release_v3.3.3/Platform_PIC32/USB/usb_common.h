...
typedef BOOL (*USB_EVENT_HANDLER) ( USB_EVENT event, void *data, UINT32 size );
...
/****************************************************************************
  ...
  ***************************************************************************/
        ...
        #else
            //#error "Application must define support mode in usb_config.h" // Compiler is flagging this error even though it shouldn't
        #endif
    #endif
#endif
...
/****************************************************************************
  ...
  ***************************************************************************/
        ...
        #else
            //#error "Application must define support mode in usb_config.h" //Compiler flags as error even though USB_SUPPORT_DEVICE is defined
        #endif
    #endif
#endif
