...
/****************************************************************************
  Function:
    void Delay10us( FSC_U32 tenMicroSecondCounter )
  ...
  Parameters:
    FSC_U32 tenMicroSecondCounter - number of ten microsecond delays
    to perform at once.
...
void Delay10us( FSC_U32 tenMicroSecondCounter )
{
    volatile FSC_S32 cyclesRequiredForEntireDelay;    
        ...
        else
        {
            ...
            cyclesRequiredForEntireDelay = (FSC_S32)(GetInstructionClock()/100000) * tenMicroSecondCounter;
...
/****************************************************************************
  ...
  Parameters:
    FSC_U16 ms - number of one millisecond delays to perform at once.
...
void DelayMs( FSC_U16 ms )
{
        ...
        FSC_S32 cyclesRequiredForEntireDelay;
