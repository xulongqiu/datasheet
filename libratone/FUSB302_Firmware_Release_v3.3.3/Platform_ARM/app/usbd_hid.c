                               ...
                               uint8_t cfgidx)
{
  ...
  else
  {
     ...
     /* Prepare Out endpoint to receive 1st packet */
      USBD_LL_PrepareReceive(pdev, HID_EPOUT_ADDR, USBInputMsg,
                              ...
                              uint8_t epnum)
{
...
#ifdef FSC_DEBUG
  // HOSTCOMM interface for processing and responding to GUI requests.
  ProcessMsg( USBInputMsg, USBOutputMsg );
  ...
  // Send response
  USBD_HID_SendReport(&USBD_Device, USBOutputMsg, 64);
