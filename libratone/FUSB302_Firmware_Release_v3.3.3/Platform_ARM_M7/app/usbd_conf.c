...
{    
  ...
  // NOTE (JB) - Changed low power enable to 0.  Was halting on disconnect.
  ...
  /* Control Endpoints */  // TODO???
//  HAL_PCDEx_PMAConfig(&hpcd , 0x00 , PCD_SNG_BUF, 0x18);
//  HAL_PCDEx_PMAConfig(&hpcd , 0x80 , PCD_SNG_BUF, 0x58);

  /* Send/Receive Endpoints */
//  HAL_PCDEx_PMAConfig(&hpcd , HID_EPIN_ADDR , PCD_SNG_BUF, 0x100);
//  HAL_PCDEx_PMAConfig(&hpcd , HID_EPOUT_ADDR , PCD_SNG_BUF, 0x140);
...
{
  static uint8_t mem[MAX_STATIC_ALLOC_SIZE];
  return mem;
}
