...
#define INT_N_PIN       GPIO_PIN_0

#define VBUS_PORT       GPIOF
#define VBUS_5V_PIN     GPIO_PIN_7
#define VBUS_12V_PIN    GPIO_PIN_6

void InitializeGPIO( void )
{
    GPIO_InitTypeDef  GPIO_InitStruct;

    // * Outputs (VBUS Controls, etc.) on Port F
    __GPIOF_CLK_ENABLE();
    ...
    GPIO_InitStruct.Pin = VBUS_5V_PIN | VBUS_12V_PIN;
